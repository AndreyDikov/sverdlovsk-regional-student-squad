package ru.application.notificationmicroservice.configurations;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UserEventMessage> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new JsonDeserializer<>(UserEventMessage.class, false)
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserEventMessage> kafkaListenerContainerFactory(
