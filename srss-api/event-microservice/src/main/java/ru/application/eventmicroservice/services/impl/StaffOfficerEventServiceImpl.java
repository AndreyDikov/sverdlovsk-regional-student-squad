...
public class StaffOfficerEventServiceImpl implements StaffOfficerEventService {
    ...
    public Event create(
        ...
        UUID categoryEvaluationMethodUuid = getCategoryEvaluationMethodUuid(categoryUuid, evaluationMethod);
    ...
    private UUID getCategoryEvaluationMethodUuid(
            UUID categoryUuid,
            EvaluationMethod evaluationMethod
    ) {
        return categoryEvaluationMethodRepository
